...
export default function Hero({ variant = 'default' }: HeroProps) {
	...
	return (
		<section className="relative flex-1 flex flex-col items-center justify-start py-12 px-4 md:px-8 bg-bg overflow-y-auto w-full pb-32">
			...
			>
				<div className="bg-white/10 text-white shadow-[0_8px_32px_0_rgba(0,0,0,0.37),inset_0_1px_1px_0_rgba(255,255,255,0.25)] rounded-2xl px-6 py-3.5 border border-white/20 flex items-center gap-3 backdrop-blur-xl hover:border-white/35 transition-all">
			...
			<div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
				...
				<div className="col-span-1 md:col-span-2 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] flex flex-col justify-center relative overflow-hidden group hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
				...
				<div id="contact" className="col-span-1 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] flex flex-col justify-center hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-4 text-text flex items-center gap-2">
						<span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
						Contact & Liens
					</h3>
					<div className="flex flex-col gap-4">
						<button onClick={handleCopyEmail} className="text-text hover:text-primary transition-colors flex items-center gap-3 p-2.5 rounded-xl bg-white/[0.075] backdrop-blur-md border border-white/15 text-left w-full">
						...
						<a href="#" className="text-text-muted hover:text-primary transition-colors flex items-center gap-3 p-2.5 rounded-xl bg-white/[0.075] backdrop-blur-md border border-white/15">
							<span className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0 border border-white/10">
						...
						<a href="https://github.com/hle-roux" className="text-text-muted hover:text-primary transition-colors flex items-center gap-3 p-2.5 rounded-xl bg-white/[0.075] backdrop-blur-md border border-white/15">
							<span className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0 border border-white/10">
								<svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
				...
				<div className="col-span-1 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] flex flex-col hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
					...
					<div className="flex flex-col gap-6 flex-1">
						<div className="relative pl-6 border-l-2 border-primary/40">
							<span className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-surface border-2 border-primary shadow-[0_0_10px_rgba(52,211,153,0.5)]"></span>
				...
				<div id="competences" className="col-span-1 md:col-span-2 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-6 text-text border-b border-white/10 pb-4">Compétences & Expertise</h3>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						{/* Group 1 */}
						<div className="bg-white/[0.075] backdrop-blur-md p-5 rounded-2xl border border-white/15 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.15)]">
				...
				<div id="technologies" className="col-span-1 md:col-span-3 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
					...
					<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
						{/* Python */}
						<div className="bg-white/[0.075] backdrop-blur-md p-4 rounded-2xl border border-white/15 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.15)] flex flex-col items-center justify-center gap-3 group">
				...
				<div id="projets" className="col-span-1 md:col-span-3 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-6 text-text border-b border-white/10 pb-4 flex justify-between items-center">
						<span>Projets Principaux</span>
						<button className="text-sm font-medium text-primary hover:text-primary-hover flex items-center gap-1 transition-colors bg-primary/10 px-3 py-1.5 rounded-lg border border-white/10 hover:border-primary/50 hover:bg-primary/20 backdrop-blur-md shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						{/* Projet 1 */}
						<a href="https://mylifehub.vercel.app" className="group rounded-2xl overflow-hidden bg-white/[0.075] backdrop-blur-md border border-white/15 shadow-[0_4px_20px_0_rgba(0,0,0,0.25),inset_0_1px_1px_0_rgba(255,255,255,0.15)] flex flex-col h-full">
						...
						{/* Projet 2 */}
						<a href="#" className="group rounded-2xl overflow-hidden bg-white/[0.075] backdrop-blur-md border border-white/15 shadow-[0_4px_20px_0_rgba(0,0,0,0.25),inset_0_1px_1px_0_rgba(255,255,255,0.15)] flex flex-col h-full">
							<div className="h-48 bg-gradient-to-br from-white/10 to-transparent relative overflow-hidden border-b border-white/10">
								<div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(52,211,153,0.15)_0%,transparent_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
				...
				<div className="col-span-1 md:col-span-3 bg-white/[0.035] backdrop-blur-sm rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.36),inset_0_1px_1px_0_rgba(255,255,255,0.25)] hover:bg-white/[0.07] hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-6 text-text border-b border-white/10 pb-4 flex justify-between items-center">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						{/* Projet 1 */}
						<a className="group rounded-2xl overflow-hidden bg-white/[0.075] backdrop-blur-md border border-white/15 shadow-[0_4px_20px_0_rgba(0,0,0,0.25),inset_0_1px_1px_0_rgba(255,255,255,0.15)] flex flex-col h-full">
							<div className="h-48 bg-gradient-to-br from-white/10 to-transparent relative overflow-hidden border-b border-white/10">
								<div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(52,211,153,0.15)_0%,transparent_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
