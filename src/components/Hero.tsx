	...
	return (
		<section className="relative flex-1 flex flex-col items-center justify-start py-12 px-4 md:px-8 overflow-y-auto w-full pb-32">
			...
			<div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
				...
				<div id="contact" className="col-span-1 bg-slate-900/35 backdrop-blur-xl rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] flex flex-col justify-center hover:bg-slate-900/50 hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-4 text-text flex items-center gap-2">
						<span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
						Contact & Liens
					</h3>
					<div className="flex flex-col gap-4">
						<button onClick={handleCopyEmail} className="text-text hover:text-primary transition-colors flex items-center gap-3 p-2.5 rounded-xl bg-slate-800/25 backdrop-blur-lg border border-white/15 text-left w-full">
						...
						<a href="#" className="text-text-muted hover:text-primary transition-colors flex items-center gap-3 p-2.5 rounded-xl bg-slate-800/25 backdrop-blur-lg border border-white/15">
							<span className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0 border border-white/10">
				...
				<div className="col-span-1 bg-slate-900/35 backdrop-blur-xl rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] flex flex-col hover:bg-slate-900/50 hover:border-white/35 transition-all duration-300">
				...
				<div id="competences" className="col-span-1 md:col-span-2 bg-slate-900/35 backdrop-blur-xl rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] hover:bg-slate-900/50 hover:border-white/35 transition-all duration-300">
				...
				<div id="technologies" className="col-span-1 md:col-span-3 bg-slate-900/35 backdrop-blur-xl rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] hover:bg-slate-900/50 hover:border-white/35 transition-all duration-300">
					...
					<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
						{/* Python */}
						<div className="bg-slate-800/25 backdrop-blur-lg p-4 rounded-2xl border border-white/15 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.15)] flex flex-col items-center justify-center gap-3 group">
				...
				<div id="projets" className="col-span-1 md:col-span-3 bg-slate-900/35 backdrop-blur-xl rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] hover:bg-slate-900/50 hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-6 text-text border-b border-white/10 pb-4 flex justify-between items-center">
				...
				<div className="col-span-1 md:col-span-3 bg-slate-900/35 backdrop-blur-xl rounded-[var(--radius-xl)] p-8 border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.3),inset_0_1px_1px_0_rgba(255,255,255,0.2)] hover:bg-slate-900/50 hover:border-white/35 transition-all duration-300">
					<h3 className="text-xl font-bold mb-6 text-text border-b border-white/10 pb-4 flex justify-between items-center">
